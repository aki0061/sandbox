...
public class ObjectFactory {
    ...
    private final static QName _DateAttribute_QNAME = new QName("urn:ietf:params:xml:ns:icalendar-2.0", "date-attribute");
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:ietf:params:xml:ns:icalendar-2.0", name = "date-attribute")
